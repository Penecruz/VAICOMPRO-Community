    ...
    namespace Static
    {
        ...
        public static class EditorCatLabels
        {
            ...
            public static Dictionary<CommandCategories, string> Commands = new Dictionary<CommandCategories, string>()
            {
                ...
                {CommandCategories.AH64D_George,                "AH-64D AI"                     },
                {CommandCategories.AH64D_George_roe,            "AH-64D AI | ROE"               },
                {CommandCategories.AH64D_George_CPG,            "AH-64D AI CP/G"                },
                {CommandCategories.AH64D_George_CPG_startup,    "AH-64D AI CP/G | Startup"      },
                {CommandCategories.AH64D_George_CPG_search,     "AH-64D AI CP/G | Search"       },
                {CommandCategories.AH64D_George_CPG_sensors,    "AH-64D AI CP/G | Sensors"      },
                {CommandCategories.AH64D_George_CPG_targets,    "AH-64D AI CP/G | Targets"      },
                {CommandCategories.AH64D_George_CPG_weapons,    "AH-64D AI CP/G | Weapons"      },
                {CommandCategories.AH64D_George_PLT,            "AH-64D AI Pilot"               },
                {CommandCategories.AH64D_George_PLT_ground,     "AH-64D AI Pilot | Ground"      },
                {CommandCategories.AH64D_George_PLT_hover,      "AH-64D AI Pilot | Hover"       },
                {CommandCategories.AH64D_George_PLT_flight,     "AH-64D AI Pilot | Flight"      },
                {CommandCategories.AH64D_George_PLT_combat,     "AH-64D AI Pilot | Combat"      },
                {CommandCategories.AH64D_George_PLT_defensive,  "AH-64D AI Pilot | Defensive"   },
