    ...
    namespace Database
    {
        ...
        public static partial class Recipients
        {
            ...
            public static Dictionary<string, Recipient> Table = new Dictionary<string, Recipient>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "BAS100",                     new Recipient { uniqueid = 15601, category = RecipientCategories.aiatc, name = "wAIUnitATCCKolaBAS100",  displayname = Labels.airecipients["BAS 100"], blockedforFree = true  } },
                ...
                { "Kemi Tornio",                new Recipient { uniqueid = 15603, category = RecipientCategories.aiatc, name = "wAIUnitATCKolaKemiTornio",  displayname = Labels.airecipients["KemiTornio"], blockedforFree = true  } },
                ...
                { "Severomorsk1",               new Recipient { uniqueid = 15610, category = RecipientCategories.aiatc, name = "wAIUnitATCKolaSeveromorsk1",  displayname = Labels.airecipients["Severomorsk-1"], blockedforFree = true  } },
                { "Severomorsk3",               new Recipient { uniqueid = 15611, category = RecipientCategories.aiatc, name = "wAIUnitATCKolaSeveromorsk3",  displayname = Labels.airecipients["Severomorsk-3"], blockedforFree = true  } },
                ...
                { "Murmansk International",     new Recipient { uniqueid = 15613, category = RecipientCategories.aiatc, name = "wAIUnitATCKolaMurmansk",  displayname = Labels.airecipients["Murmansk International"], blockedforFree = true  } },
