    ...
    namespace Database
    {
        ...
        public static partial class Recipients
        {
            ...
            public static Dictionary<string, Recipient> Table = new Dictionary<string, Recipient>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "Paphos",                     new Recipient { uniqueid = 15329, category = RecipientCategories.aiatc, name = "wAIUnitATCSyriaPaphos",  displayname = Labels.airecipients["Paphos"], blockedforFree = true  } },
                { "Lakatamia",                  new Recipient { uniqueid = 15330, category = RecipientCategories.aiatc, name = "wAIUnitATCSyriaLakatamia",  displayname = Labels.airecipients["Lakatamia"], blockedforFree = true  } },
                { "Ercan",                      new Recipient { uniqueid = 15331, category = RecipientCategories.aiatc, name = "wAIUnitATCSyriaErcan",  displayname = Labels.airecipients["Ercan"], blockedforFree = true  } },

                { "wAIUnitATCSyriaMaximum",     new Recipient { uniqueid = 15339, category = RecipientCategories.aiatc, name = "wAIUnitATCSyriaMaximum",           } },
                ...
                { "Wadi Abu Rish",              new Recipient { uniqueid = 15371, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiWadiAbuRish",  displayname = Labels.airecipients["Wadi Abu Rish"], blockedforFree = true  } },
                { "Ramon International Airport", new Recipient { uniqueid = 15372, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiRamonInternationalAirport",  displayname = Labels.airecipients["Ramon International Airport"], blockedforFree = true  } },
                { "Sharm El Sheikh International Airport",  new Recipient { uniqueid = 15373, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiSharmElSheikh",  displayname = Labels.airecipients["Sharm El Sheikh International Airport"], blockedforFree = true  } },
                { "Hurghada International Airport",  new Recipient { uniqueid = 15374, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiHurghadaInternationalAirport",  displayname = Labels.airecipients["Hurghada International Airport"], blockedforFree = true  } },
                { "Al Bahr al Ahmar",           new Recipient { uniqueid = 15375, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiAlBahralAhmar",  displayname = Labels.airecipients["Al Bahr al Ahmar"], blockedforFree = true  } },
                { "El Minya",                   new Recipient { uniqueid = 15376, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiElMinya",  displayname = Labels.airecipients["El Minya"], blockedforFree = true  } },
                { "Beni Suef",                  new Recipient { uniqueid = 15377, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiBeniSuef",  displayname = Labels.airecipients["Beni Suef"], blockedforFree = true  } },
                { "Kom Awshim",                 new Recipient { uniqueid = 15378, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiKomAwshim",  displayname = Labels.airecipients["Kom Awshim"], blockedforFree = true  } },
                { "Quwaysina",                  new Recipient { uniqueid = 15379, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiQuwaysina",  displayname = Labels.airecipients["Quwaysina"], blockedforFree = true  } },
                { "Birma Air Base",             new Recipient { uniqueid = 15380, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiBirmaAirBase",  displayname = Labels.airecipients["Birma Air Base"], blockedforFree = true  } },
                { "Gebel El Basur Air Base",    new Recipient { uniqueid = 15381, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiGebelElBasur",  displayname = Labels.airecipients["Gebel El Basur Air Base"], blockedforFree = true  } },
                { "Al Rahmaniyah Air Base",     new Recipient { uniqueid = 15382, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiAlRahmaniyah",  displayname = Labels.airecipients["Al Rahmaniyah Air Base"], blockedforFree = true  } },
                { "Jiyanklis Air Base",                  new Recipient { uniqueid = 15383, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiJiyanklis",  displayname = Labels.airecipients["Jiyanklis Air Base"], blockedforFree = true  } },
                { "Borj El Arab International Airport",  new Recipient { uniqueid = 15384, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiJBorjElArab",  displayname = Labels.airecipients["Borj El Arab International Airport"], blockedforFree = true  } },

                { "wAIUnitATCSinaiMaximum",     new Recipient { uniqueid = 15390, category = RecipientCategories.aiatc, name = "wAIUnitATCSinaiMaximum",           } },
                ...
                { "Tarinkot",                   new Recipient { uniqueid = 15491, category = RecipientCategories.aiatc, name = "wAIUnitATCCAfghanTarinkot",  displayname = Labels.airecipients["Tarinkot"], blockedforFree = true  } },
                ...
                { "Qala i Naw",                 new Recipient { uniqueid = 15499, category = RecipientCategories.aiatc, name = "wAIUnitATCAfghanQala i Naw",  displayname = Labels.airecipients["Qala i Naw"], blockedforFree = true  } },
                ...
                { "wAIUnitATCAfghanMaximum",   new Recipient { uniqueid = 15550, category = RecipientCategories.aiatc, name = "wAIUnitATCAfghanMaximum",           } },
