...
namespace VAICOM
{
    namespace Database
    {
        ...
        public static partial class Commands
        {
            ...
            { "wMsgLeaderCheckingIn",           new Command { uniqueid = 18033, category = CommandCategories.aicommscarrier, dcsid = "wMsgLeaderCheckingIn",            displayname = Labels.aicommands["wMsgLeaderCheckingIn"],blockedforFree = true, requiresrealatc = true        } },
