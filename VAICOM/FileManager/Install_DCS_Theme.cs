            ...
            public static partial class Lua
            {
                ...
                public static void Install_DCS_Theme(string path)
                {
                    ...
                    try
                    {
                        ...
                        string insert;
                        insert = "VAICOM PRO - interactive voice communications plugin";
                        ...
                        insert = "DISCLAIMER: VAICOM PRO is not an official ED partner module. Eagle Dynamics cannot be contacted with questions in relation to this software.";
