    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"F-5E",    new DCSmodule() { Id ="F-5E-3",Name = "F-5E",    Alias = "Tiger II",     ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false,  Havedial = false, Theme = "RedFlag",   SpeechAlias = "F Five E"  } },
                ...
                {"AH-64D",  new DCSmodule() { Id ="AH-64D",Name = "AH-64D",  Alias = "Apache",     ProOnly = true,  IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = true, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = false,  Havedial = true, Theme = "NATO",    SpeechAlias = "Apache"  } },
                ...
                // VPC Additions
                {"MB-339A", new DCSmodule() { Id ="MB-339A",Name = "MB-339A", Alias = "", ProOnly = true, IsFC = false, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false,  Havedial = false, Theme = "NATO", SpeechAlias = "M..Bee Three Three Nine"  } },
				...
				// community Mods
                {"A-4E-C",  new DCSmodule() { Id ="A-4E-C", Name = "A-4", Alias = "Skyhawk", ProOnly = true,  IsFC = true, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight2 ,Singlehotkey = false,  Havedial = false, Theme = "RedFlag",      SpeechAlias = "Sky Hawk" } },
                ...
                // {"VNAO_T45",    new DCSmodule() { Id ="VNAO_T45", Name = "VNAO_T45", Alias = "Goshawk", ProOnly = true, IsFC = true,  ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = false, Havedial = false, Theme = "NATO",    SpeechAlias = "Tee Forty Five" } },
            };
        }
    }
}
