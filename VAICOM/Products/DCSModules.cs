    ...
    namespace Products
    {
        ...
        public static class DCSmodules
        {
            ...
            public static Dictionary<string, DCSmodule> LookupTable = new Dictionary<string, DCSmodule>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {"F-5E FC", new DCSmodule() { Id ="F-5E-3_FC",Name = "F-5E", Alias = "Tiger II",    ProOnly = true,  IsFC = true, ApxWpn = true, ApxDir = false,  IsHelo = false, Flightmenu = DcsClient.iCommandsequences.showflight1 ,Singlehotkey = true,  Havedial = false, Theme = "Fallon",   SpeechAlias = "F Five E Two"  } }, //Add Flaming Cliffs version, does it use FC radios?
